...
This repository serves as my QA portfolio, showcasing real-world testing projects, automation frameworks, API collections, and structured test documentation. It reflects my practical experience in identifying defects, validating business requirements, and ensuring high product quality before release.

I approach testing with a strong focus on:

Edge cases and negative scenarios

Clear, reproducible bug reports

Structured and maintainable test documentation
...
Documentation: Test Cases, Bug Reports, Test Summary Reports
...
Focus areas: User authentication, form validation, navigation

🔗 ReqRes API — Postman Collection

API test collection built using Postman to validate RESTful endpoints on the ReqRes mock API.
...
I apply industry-standard techniques such as:
...
Ability to manage multiple testing cycles effectively
...
GitHub: https://github.com/oluwatobilob4

LinkedIn: https://www.linkedin.com/in/abionaoluwatobi/
